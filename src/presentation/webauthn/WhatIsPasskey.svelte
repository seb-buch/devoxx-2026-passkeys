...
<Slide>
  <h3>C'est quoi une passkey ?</h3>
  <Todo />
  <p>
    Une passkey est un credential FIDO2 (Webauthn) basé sur la cryptographie asymétrique, géré par
    le navigateur et l'OS, qui remplace le mot de passe.
  </p>
  <ul>
    <li>🔐 Pas de secret partagé — rien à voler côté serveur</li>
    <li>🌐 Liée à l'origine (domaine) — impossible à phisher</li>
  ...
  <SpeakerNotes>
    ...
    marche en détail, il faut d'abord parler un peu de cryptographie.
  </SpeakerNotes>
</Slide>
