...
<Slide>
  ...
  <figure>
    <img
      src="https://www.inovex.de/wp-content/uploads/2019/12/Screenshot-2019-12-01-at-11.06.31.png"
      alt="Protocoles FIDO2"
      style="height: 200px;"
    />
  </figure>

  <figure class="fido2-explanation">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" class="fingerprint"
      ><path
  ...
  <ul>
    <li>
      <strong>FIDO2</strong> — la norme globale (FIDO Alliance)
      <ul>
        <li><strong>WebAuthn</strong> (W3C) — API JavaScript côté navigateur</li>
        <li><strong>CTAP</strong> — communication navigateur ↔ authenticator</li>
      </ul>
    </li>
  </ul>
  <SpeakerNotes>
    Avant de plonger dans le code, situons les différents termes que vous allez rencontrer. FIDO2,
