...
<Slide>
	<h2>C'est quoi une passkey ?</h2>
	<p>
		Une passkey est un credential FIDO2 basé sur la cryptographie asymétrique, géré par le
		navigateur et l'OS, qui remplace le mot de passe.
	</p>
	<ul>
